...
router.post("/api/weeklyperformances/:WeeklyQuizid", updateWeeklyPerformance);

// Delete a specific weekly performance entry by ID
router.delete("/api/weeklyperformances/:id", deleteWeeklyPerformance);

router.post(
  "/api/Get_Weekly_Performance_of_Student/:id",
  Get_Weekly_Performance_of_Student
);
...
router.post("/api/Create_Progress",Create_Progress)
